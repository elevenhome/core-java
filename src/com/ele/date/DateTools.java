 ...
 * @Description TODO
 * @Author zzw
 * @Date 2019年1月17日21:57:47
 */

//参考文档
//https://www.aliyun.com/jiaocheng/278422.html
public class DateTools {
    public static void main(String[] args) {
//        System.out.println("--------------当前日期下一周的每一天--------------");
//        List<String> lst = getALlweekDays();
//        //获取当前日期下,一周的每一天
//        for (String s : lst) {
//            System.out.println(s);
//        }
//        List<String> lst2 = getAllDaysMonth();
//        //获取当前日期下,一个月的每一天 System.out.println("--------------一个月的每一天--------------");
//        for (String s2 : lst2) {
...
//        }
        ...
        System.out.println("--------------根据特定的日期 获取特定日期所在一周的每一天--------------");
        Date d = DateTools.paraseStringToDate("2019-01-17");
